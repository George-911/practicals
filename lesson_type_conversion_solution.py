...
# Create a variable called 'quantity' as an integer with a value of 5.
quantity = 5
...
# Covert the total_cost to an integer {round down} and store it in a variable called 'total_cost_int'
total_cost_int = int(total_cost)

# Print out 'price', 'price_float', 'quantity', 'total_cost' and 'total_cost_int'Print(f"price (string):{price} , Type; {type(price)} ")
